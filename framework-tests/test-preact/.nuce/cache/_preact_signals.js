import {
  ...
  _,
  q
} from "./chunks/chunk-5CRDIROO.js";
import {
  b,
  k,
  l,
  t
} from "./chunks/chunk-WATLBGW5.js";
...
var k2 = function(i2) {
  for (var t3 in i2) {
    var n2 = i2[t3];
    if ("function" == typeof n2) i2[t3] = C(n2);
...
function w2(i2, n2, r2, t3) {
  var o2 = n2 in i2 && void 0 === i2.ownerSVGElement, e2 = y(r2), f2 = r2.peek();
...
b.prototype.shouldComponentUpdate = function(i2, n2) {
...
function T2() {
  if (1 === m2.push(this)) (l.requestAnimationFrame || k3)(A);
}
function x2() {
  n(function() {
    var i2;
    while (i2 = _3.shift()) l3.call(i2);
  });
}
function F2() {
...
//# sourceMappingURL=_preact_signals.js.map
