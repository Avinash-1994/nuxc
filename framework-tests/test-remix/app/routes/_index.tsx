...
const JOBS = [
  ...
  { id:2, title:'Staff Engineer — Build Tools', company:'Zeptr Inc.', location:'Remote / SF', salary:'$200k–$250k', type:'Full-time', stack:['Rust','TypeScript','Node'] },
  ...
  return (
    <div style={{minHeight:'100vh',background:'#0f172a',color:'#f1f5f9',fontFamily:'system-ui'}}>
      <nav style={{background:'#1e293b',padding:'0 24px',display:'flex',alignItems:'center',height:56,gap:24}}>
        <span style={{fontWeight:700,fontSize:18}}>💼 Zeptr Jobs</span>
