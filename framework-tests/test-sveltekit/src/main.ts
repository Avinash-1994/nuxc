// SvelteKit test project uses Nuce to serve a static Svelte SPA
// (SSR requires SvelteKit's own adapter, this shows the SPA shell)
console.log('⚡ Nuce SvelteKit template loaded');
...
<main>
  ...
  <p class="subtitle">From the Nuce team — built with SvelteKit <span class="badge">SvelteKit</span></p>
  <article>
    <div class="meta">Performance · May 2025</div>
    <h2>How Nuce Achieves Sub-10ms Cold Starts</h2>
  ...
  <article>
    ...
    <p>Nuce reads your package.json dependencies and infers the correct transformer, preset, and dev server config — no nuce.config.ts required for the most common setups.</p>
