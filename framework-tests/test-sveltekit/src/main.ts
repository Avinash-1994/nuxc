// SvelteKit test project uses Sparx to serve a static Svelte SPA
// (SSR requires SvelteKit's own adapter, this shows the SPA shell)
console.log('⚡ Sparx SvelteKit template loaded');
...
<nav>
  <span>⚡ Sparx Blog</span>
  <a href="#">Home</a><a href="#">Articles</a><a href="#">Docs</a><a href="#">About</a>
</nav>
<main>
  <h1>Engineering Insights</h1>
  <p class="subtitle">From the Sparx team — built with SvelteKit <span class="badge">SvelteKit</span></p>
  <article>
    <div class="meta">Performance · May 2025</div>
    <h2>How Sparx Achieves Sub-10ms Cold Starts</h2>
  ...
  <article>
    ...
    <p>Sparx reads your package.json dependencies and infers the correct transformer, preset, and dev server config — no sparx.config.ts required for the most common setups.</p>
