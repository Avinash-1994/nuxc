...
exports.render = async function render({ url, cookies }) {
  ...
  if (url.includes('/dashboard')) {
    ...
    html = [
      ...
      '    <p>Powered by Nuce SSR - SvelteKit Adapter v1.0.0</p>',
      '  </footer>',
      '</main>'
    ].join('\n');
  }
  return {
    html: html,
    head: '<title>Dashboard | Nuce SSR</title><meta name="description" content="SvelteKit SSR Dashboard"><meta name="robots" content="noindex">',
