...
import {
  ...
  tag,
  writable
} from "./chunks/chunk-BWO5OB3N.js";
import {
  dev_fallback_default
} from "./chunks/chunk-FD4SWEYD.js";
import "./chunks/chunk-3VAEX2ZP.js";
import {
  __privateAdd,
  __privateGet,
  __privateMethod,
  __privateSet
} from "./chunks/chunk-ZBIXCTB4.js";
...
var _Spring = class _Spring {
   ...
   */
  set(value, options) {
    __privateGet(this, _deferred)?.reject(new Error("Aborted"));
    if (options?.instant || __privateGet(this, _current).v === void 0) {
      __privateGet(this, _task)?.abort();
...
var _Tween = class _Tween {
  ...
  set(value, options) {
    ...
    if (duration === 0) {
      __privateGet(this, _task2)?.abort();
...
var prefersReducedMotion = /* @__PURE__ */ new MediaQuery(
