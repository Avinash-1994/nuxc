...
// Write package.json and index.html to allow Nuce CLI build to succeed
...
// Add nuce.config.ts to enable SSR preset
...
var ssrLines = [
  ...
  "  return {",
  "    html: html,",
  "    head: '<title>Dashboard | Nuce SSR</title><meta name=\"description\" content=\"SvelteKit SSR Dashboard\">',",
