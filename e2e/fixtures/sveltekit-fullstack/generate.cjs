...
// Write package.json and index.html to allow Sparx CLI build to succeed
...
// Add sparx.config.ts to enable SSR preset
...
var ssrLines = [
  ...
  "  return {",
  "    html: html,",
  "    head: '<title>Dashboard | Sparx SSR</title><meta name=\"description\" content=\"SvelteKit SSR Dashboard\">',",
