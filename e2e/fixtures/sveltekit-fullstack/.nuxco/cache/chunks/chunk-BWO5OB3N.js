...
} from "./chunk-FD4SWEYD.js";
import {
  async_mode_flag,
  legacy_mode_flag,
  tracing_mode_flag
} from "./chunk-3VAEX2ZP.js";
import {
  __privateAdd,
  __privateGet,
  __privateMethod,
...
update_pending_count_fn = function(d, batch) {
  ...
  if (!this.has_pending_snippet()) {
    if (this.parent) {
      __privateMethod(_a = this.parent, _Boundary_instances, update_pending_count_fn).call(_a, d, batch);
    }
    return;
  }
...
process_fn = function() {
  ...
  if (next_batch !== null) {
    ...
    __privateMethod(_a = next_batch, _Batch_instances, process_fn).call(_a);
  }
    ...
    if (others.length === 0) {
        ...
        for (const unskipped of __privateGet(this, _unskipped_branches)) {
          batch.unskip_effect(unskipped, (e) => {
            ...
            if ((e.f & (BLOCK_EFFECT | ASYNC)) !== 0) {
              ...
              __privateMethod(_a2 = batch, _Batch_instances, defer_effects_fn).call(_a2, [e]);
            }
          });
        }
      }
      ...
      if (__privateGet(batch, _roots).length > 0) {
        ...
        for (var root of __privateGet(batch, _roots)) {
          __privateMethod(_a = batch, _Batch_instances, traverse_fn).call(_a, root, [], []);
        }
...
//# sourceMappingURL=chunk-BWO5OB3N.js.map
