...
const srcPath = path.resolve(__dirname, '../../../packages/zeptr-plugin-runner/dist/runner.js');
let runnerModule;
...
try {
  ...
  runnerModule = await import('../../../packages/zeptr-plugin-runner/dist/runner.js').catch(() => null);
