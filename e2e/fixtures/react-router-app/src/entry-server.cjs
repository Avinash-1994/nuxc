 ...
 * Sparx Phase 2.9 — React Router v7 Meta-framework
 *
 * Implements:
...
function renderRoute(url, opts) {
  ...
  if (isProfile && username) {
    ...
    loaderData = {
      ...
      bio: 'Software engineer at Sparx',
      repos: ['sparx-core', 'sparx-adapter', 'react-app'],
    };
  }
  ...
  if (loaderData) {
    ...
    bodyContent = '<main><h1>About</h1><p>Sparx React Router Platform — Phase 2.9</p></main>';
  } else {
    bodyContent = [
      '<main>',
...
function emitBuildArtifacts(appRoot, outDir) {
  ...
  // Server bundle
  var serverBundle = [
    '// Sparx React Router — Server Bundle (Phase 2.9)',
    '"use strict";',
