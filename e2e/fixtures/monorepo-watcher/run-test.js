...
const NATIVE_NODE_PATH = path.join(process.cwd(), 'native/nuxc_native.linux-x64-gnu.node');
const NATIVE_BAK_PATH = path.join(process.cwd(), 'native/nuxc_native.linux-x64-gnu.node.bak');
const NATIVE_ROOT_NODE_PATH = path.join(process.cwd(), 'nuxc_native.node');
const NATIVE_ROOT_BAK_PATH = path.join(process.cwd(), 'nuxc_native.node.bak');
