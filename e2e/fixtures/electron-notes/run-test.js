...
async function runTests() {
  ...
  try {
    ...
    // Write to renderer file — triggers Zeptr HMR for renderer
  ...
  const mainHasMock     = mainContent2.includes('// [Zeptr]') || mainContent2.includes('mock');
  const rendererHasMock = rendererContent2.includes('// [Zeptr]') || rendererContent2.includes('mock');
  ...
  // ─────────────────────────────────────────────
  log(`┌─────────────────────────────────────────────────┐`);
  log(`│ ZEPTR — PHASE 2.14 ELECTRON COMPLETE            │`);
