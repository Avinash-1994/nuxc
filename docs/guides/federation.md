...
Build micro-frontends with Nuce's native Module Federation support.
...
import { loadRemote } from '@nuce/runtime/federation';
...
```typescript
import { checkRemoteHealth } from '@nuce/runtime/federation';
