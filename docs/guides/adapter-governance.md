# Nuce Adapter Governance

**Module**: 9 (Phase H.1)  
**Status**: ✅ Active  
**Enforced By**: Nuce Core Team
...
1.  **Survive 2 minor Nuce releases** without breaking.
...
1.  **Filesystem Constraints**:
    ...
    *   Adapters **MUST NOT** modify Nuce Core files or Configuration.
