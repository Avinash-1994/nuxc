...
> Build Vue 3 apps with Nuxc — SFC hot-reload, Composition API, TypeScript, CSS Modules.
...
```bash
nuxc bootstrap --name my-vue-app --template vue-ts
cd my-vue-app
nuxc dev
```
...
Nuxc integrates **Vue SFC hot-reload** automatically for `.vue` files.
