...
Nuxco implements **defense-in-depth** security:
...
# Output:
✅ Signature valid
✅ Publisher: Nuxco Team <security@nuxco.dev>
...
```json
{
  ...
  "signature": {
    ...
    "signer": "Nuxco Team <security@nuxco.dev>"
  },
  "integrity": {
...
Nuxco applies **strict CSP** by default:
...
Nuxco generates **SRI hashes** for all assets:
...
Nuxco runs **automated security scans**:
...
```typescript
import { sanitize } from 'nuxco/security';
...
1. **Email**: security@nuxco.dev
2. **PGP Key**: [Download](https://nuxco.dev/security.asc)
...
nuxco update --security-only

# Subscribe to security advisories
nuxco security subscribe
```
...
- [Nuxco Security Blog](https://nuxco.dev/blog/security)
