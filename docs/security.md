...
Zeptr implements **defense-in-depth** security:
...
# Output:
✅ Signature valid
✅ Publisher: Zeptr Team <security@zeptr.dev>
...
```json
{
  ...
  "signature": {
    ...
    "signer": "Zeptr Team <security@zeptr.dev>"
  },
  "integrity": {
...
Zeptr applies **strict CSP** by default:
...
Zeptr generates **SRI hashes** for all assets:
...
Zeptr runs **automated security scans**:
...
```typescript
import { sanitize } from 'zeptr/security';
...
1. **Email**: security@zeptr.dev
2. **PGP Key**: [Download](https://zeptr.dev/security.asc)
...
zeptr update --security-only

# Subscribe to security advisories
zeptr security subscribe
```
...
- [Zeptr Security Blog](https://zeptr.dev/blog/security)
