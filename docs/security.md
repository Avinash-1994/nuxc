...
Lunx implements **defense-in-depth** security:
...
# Output:
✅ Signature valid
✅ Publisher: Lunx Team <security@lunx.dev>
...
```json
{
  ...
  "signature": {
    ...
    "signer": "Lunx Team <security@lunx.dev>"
  },
  "integrity": {
...
Lunx applies **strict CSP** by default:
...
Lunx generates **SRI hashes** for all assets:
...
Lunx runs **automated security scans**:
...
```typescript
import { sanitize } from 'lunx/security';
...
1. **Email**: security@lunx.dev
2. **PGP Key**: [Download](https://lunx.dev/security.asc)
...
lunx update --security-only

# Subscribe to security advisories
lunx security subscribe
```
...
- [Lunx Security Blog](https://lunx.dev/blog/security)
