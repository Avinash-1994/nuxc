...
Nuxc implements **defense-in-depth** security:
...
# Output:
✅ Signature valid
✅ Publisher: Nuxc Team <security@nuxc.dev>
...
```json
{
  ...
  "signature": {
    ...
    "signer": "Nuxc Team <security@nuxc.dev>"
  },
  "integrity": {
...
Nuxc applies **strict CSP** by default:
...
Nuxc generates **SRI hashes** for all assets:
...
Nuxc runs **automated security scans**:
...
```typescript
import { sanitize } from 'nuxc/security';
...
1. **Email**: security@nuxc.dev
2. **PGP Key**: [Download](https://nuxc.dev/security.asc)
...
nuxc update --security-only

# Subscribe to security advisories
nuxc security subscribe
```
...
- [Nuxc Security Blog](https://nuxc.dev/blog/security)
