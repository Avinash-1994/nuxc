# What NOT to Touch in Zeptr Core — Internal Guide
...
This guide explains **WHAT NOT TO TOUCH** in the Zeptr codebase.
...
**Think of Zeptr core as a database**:
...
**If you're unsure, ask in #zeptr-core Slack channel.**
