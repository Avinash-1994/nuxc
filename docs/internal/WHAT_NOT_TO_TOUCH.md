# What NOT to Touch in Nuxc Core — Internal Guide
...
This guide explains **WHAT NOT TO TOUCH** in the Nuxc codebase.
...
**Think of Nuxc core as a database**:
...
**If you're unsure, ask in #nuxc-core Slack channel.**
