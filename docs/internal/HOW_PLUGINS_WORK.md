# How a Lunx Plugin Works — Internal Guide
...
This guide explains **HOW** Lunx plugins work internally, not **WHY** you should use them.
...
2. Plugin returns a `LunxPlugin` object
3. Lunx validates the plugin interface
