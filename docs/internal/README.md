# Nuce Internal Documentation — Index
...
This directory contains **internal documentation** for Nuce governance and core engineering.
...
- ✅ **Operational truth** (how Nuce actually works)
...
**Welcome to Nuce governance mode.**
