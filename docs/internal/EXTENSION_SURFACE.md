# Nuxco Extension Surface — Internal Contract
...
This document defines the **ONLY** extension points in Nuxco that are safe, supported, and guaranteed stable across minor versions.
