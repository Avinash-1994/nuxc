...
npm create nuxc@latest

# Or specify template directly
npm create nuxc@latest my-app --template react-spa
...
#### Vue SPA (TypeScript)
```bash
npm create nuxc@latest my-app --template vue-spa
```
...
```bash
npm create nuxc@latest my-app --template svelte-spa
```
...
```bash
npm create nuxc@latest my-app --template solid-spa
```
...
```bash
npm create nuxc@latest my-app --template angular-spa
```
...
```bash
npm create nuxc@latest my-app --template preact-spa
```
...
#### React SSR (Node.js)
```bash
npm create nuxc@latest my-app --template react-ssr
```
...
```bash
npm create nuxc@latest my-app --template edge-function
```
...
```bash
npm create nuxc@latest my-app --template fintech-app
```
...
#### Monorepo (PNPM)
```bash
npm create nuxc@latest my-monorepo --template monorepo
```
...
✅ **Testing setup** - Nuxc test runner
...
```bash
# 1. Create project
npm create nuxc@latest my-blog --template react-ssr
...
```bash
# 1. Create project
npm create nuxc@latest my-store --template react-spa
...
npm create nuxc@latest --list-templates
...
Missing a template? [Request it on GitHub](https://github.com/your-org/nuxc/issues/new?template=template_request.md)
