# Nuxc v2.0 Module 1 - Docker Benchmark Suite

This directory contains automated benchmarks comparing Nuxc v2.0 against 5 major rivals:
...
```
docker-suite/
├── Dockerfile.nuxc       # Nuxc v2.0 environment
