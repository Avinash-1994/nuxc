import type { Middleware } from '@nuce/adapter-core';
...
export function createSveltekitMiddleware(): Middleware {
  return async (req: any, res: any, next: any) => {
    ...
    try {
      ...
      const virtualModuleId = 'virtual:nuce/sveltekit-routes';
      let manifest: any;
      try {
      ...
      // Map SvelteKit standard fetch Request / Response pattern over Nuce's underlying uWS
      ...
      console.error('[Nuce:SvelteKit] SSR Middleware Error', e);
      next();
    }
  };
}
