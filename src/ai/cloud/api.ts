...
export class CloudAPI {
    ...
    constructor(private config: AIConfig) {
        ...
        this.baseUrl = process.env.NUXCO_CLOUD_API || 'https://api.nuxco.build';
        this.apiKey = config.apiKey || process.env.NUXCO_API_KEY || '';
    ...
    private getOrCreateUserId(): string {
        ...
        const configPath = path.join(process.env.HOME || process.env.USERPROFILE || '', '.nuxco', 'user.json');
