...
import { LunxPlugin, PluginValidation, PluginHookName } from './types.js';
...
export class PluginValidator {
     ...
     */
    async validate(plugin: LunxPlugin, sampleHook: PluginHookName, sampleInput: any): Promise<PluginValidation> {
