...
import { NucePlugin, PluginValidation, PluginHookName } from './types.js';
...
export class PluginValidator {
     ...
     */
    async validate(plugin: NucePlugin, sampleHook: PluginHookName, sampleInput: any): Promise<PluginValidation> {
