/**
 * Nuxc Build Tool - Public API
 * 
 * This is the ONLY stable public surface for Nuxc.
...
// ============================================================================
// ENV SYSTEM (.env → import.meta.env.NUXC_*)
// ============================================================================
...
export type { NuxcConfig, LoadConfigResult, ConfigValidationResult } from './config-loader.js';
...
export type { NuxcLibConfig, LibBuildResult } from './commands/lib-build.js';
