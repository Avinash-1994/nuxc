// packages/nuce-adapter-core/src/index.ts
...
export interface NuceAdapter {
  ...
  /**
   * Modify the resolved Nuce config before build
   */
  config(config: NuceConfig): NuceConfig | Promise<NuceConfig>;
   ...
   */
  ssrEntry?(config: NuceConfig): string | undefined;
